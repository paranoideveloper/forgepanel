...
//
//	1.airent.dev   UDP_HOST = "192.248.191.104"  UDP_PORT = 53   <- running
//	2.airent.dev   UDP_HOST = "192.248.191.104"  UDP_PORT = 53   <- dead
//	3.airent.dev   UDP_HOST = "192.248.191.104"  UDP_PORT = 53   <- dead
//
