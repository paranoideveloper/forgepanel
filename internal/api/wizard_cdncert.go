...
//
//	edge-b7d067ef.airent.dev:2096  status=526  Cloudflare rejected the origin's certificate
//	edge-b7d067ef.airent.dev:2087  status=526
//	edge-b7d067ef.airent.dev:2083  status=526
//
